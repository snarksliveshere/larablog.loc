                ...
                <div class="col-md-8">
                    ...
                    <article class="post">
                        ...
                        <div class="post-content">
							...
							<span
                                    class="social-share-title pull-left text-capitalize">{{ $post->author->name }}
                    ...
                    <div class="top-comment col-xs-12"><!--top comment-->
                        <div class="col-xs-6 col-sm-4 col-md-2">
                            ...
                            <img src="{{ $post->author->getAvatar() }}" class="pull-left img-circle img-responsive"
                                 alt=""></div>
                        <div class="col-xs-6 col-sm-8 col-md-10"><p>Lorem ipsum dolor sit amet, consetetur sadipscing
                                elitr, sed diam nonumy hello ro mod tempor
